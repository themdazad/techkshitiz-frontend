    ...
    <section className="bg-background/30 border-y border-white/5 backdrop-blur">
      <div className="container py-12">
        <div className="flex items-end justify-between">
          <HeadingText style={"heading font-syne font-bold text-3xl md:text-4xl text-sky-600"} text={"Quick Schedule"}/>
        ...
        <div className="mt-6 grid gap-6 md:grid-cols-3">
          {days.map((day) => (
            <div key={day} className="border border-white/10 bg-card/60 backdrop-blur p-5 animate-card">
